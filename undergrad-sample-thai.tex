...
\def\dissauthor{Supakorn Mahawongmekhin}   % 1st member
\def\dissauthortwo{Runn Siriphuwanich}   % 2nd member
\def\dissauthorthree{Nuttakit Pliankhunthud}   % 3rd member
...
เนื่องจาก Admin ภายในภาควิชาวิศวกรรมคอมพิวเตอร์นั้น มักจะได้รับคำถามที่คล้ายคลึงกันจากนักศึกษา เช่น “วันเริ่มลงทะเบียนเรียนคือวันไหน” หรือ “วิชา XXX จะสามารถเพิ่มที่นั่งหรือไม่” ซึ่งในทุกๆ ชั้นปีนั้นก็มีปัญหา คำถามและสิ่งที่ต้องการก็แตกต่างกันออกไป ต่อมาการเข้าถึงข้อมูลของทางภาควิชา ตารางงาน หรือตารางกิจกรรม ก็ไม่สามารถส่งข่าวสารข้อมูลให้กระจายไปถึงนักศึกษาทุกคนให้รับรู้ รับทราบได้ ในปัจจุบันอาจจะเป็นการส่งข้อมูล ข่าวสารกันใน LINE กลุ่ม หรือ กลุ่ม Facebook ซึ่งอาจจะไม่แจ้งเตือนทำให้นักศึกษาบางคนพลาดข้อมูลข่าวสารนั้น ซึ่งสามารถทำให้เกิดปัญหาตามมาได้ในภายหลัง
นอกจากนั้น จำนวนคำถามที่ได้รับส่วนมาก เป็นคำถามทีมีความซ้ำซ้อนกัน มักเกิดขึ้นเมื่อมีกิจกรรมที่ส่งผลต่อสถานะการเรียนของนักศึกษา ยกตัวอย่างเช่น สอบถามเกี่ยวกับการลงทะเบียนเรียนว่าจะต้องลงทะเบียนประจำปีการศึกษาในวันที่เท่าใด ในวันก่อนที่จะมีการลงทะเบียบเรียนเกิดขึ้น เป็นต้น นอกเหนือจากวันลงทะเบียนเรียน เหตุการณ์ที่มักทำให้นักศึกษาเกิดคำถามที่คล้ายกันและต้องขอความช่วยเหลือกับ admin เป็นจำนวนมาก อย่างเช่น กำหนดการสอบ การฝึกงานสำหรับนักศึกษาชั้นปีที่ 3 การจบการศึกษาสำหรับนักศึกษาชั้นปีที่ 4 ซึ่งหากรวมทุกปัญหาแล้ว จะพบว่า admin ประจำภาควิชาไม่สามารถทำงานได้เต็มประสิทธิภาพจากการที่ต้องมาตอบคำถามเหล่านั้น ซึ่งจากการที่ไม่มีระบบจัดการแก้ปัญหาในส่วนนี้ ก่อให้เกิดปัญหาต่อ Admin  
และนักศึกษาภาควิชาวิศวกรรมคอมพิวเตอร์

โดยสรุปแล้วปัญหาที่เกิดขึ้นจากการรวบรวมข้อมูลเป็นดังนี้
\begin{itemize}
  \item การส่งข้อความไปยัง Facebook ส่วนตัวของ Admin จากนักศึกษา บุคคลากร และบุคคลอื่น ในการสอบถามปัญหาต่างๆ ซึ่งจะก่อให้เกิดปัญหาในการทำงานของ Admin เช่น การตอบคำถามนอกเวลางาน  และในบางครั้งที่มีนักศึกษาส่งข้อความมาที่ Admin เป็นจำนวนมาก ทำให้ข้อความนั้นตกหล่น ปัญหาของนักศึกษาจึงไม่ได้รับการแก้ไข
  \item นักศึกษาไม่ได้รับข่าวสารภายในภาควิชาและมหาวิทยาลัยอย่างทั่วถึง ทำให้พลาดโอกาสในการเข้าร่วมกิจกรรมที่ตนสนใจจากข่าวสารนั้น 
  \item นักศึกษาไม่มีช่องทางการติดต่อกับอาจารย์โดยตรง ซึ่งในกรณีนี้ Admin จะเข้ามาช่วยเหลือเป็นหลักทำให้ภาระการทำงานของ Admin เพิ่มขึ้นเกินความจำเป็น 
  \item การขอใช้บริการห้องของภาควิชา ยังมีการขอข้อมูลของห้อง เช่น ห้องว่างหรือไม่ว่าง ยังคงต้องบอกผ่านทาง Admin โดยตรง ทำให้เกิดภาระงานกับทาง Admin เพิ่มมากยิ่งขึ้น
  ดังนั้นทางกลุ่มของนักศึกษาจึงมีความเห็นร่วมกันที่จะสร้างระบบที่สามารถอำนวยความสะดวกให้กับทั้ง Admin บุคคลากร อาจารย์ และนักศึกษา ในการเข้าถึงข้อมูลและบริการต่างๆ ของภาควิชา และช่วยจัดสรรการทำงานให้กับทาง Admin ของภาควิชาให้มีประสิทธิภาพมากขึ้น โดยใช้ Help Desk System ในการบริหารการให้บริการต่างๆ แก่นักศึกษา และลดภาระให้กับ Admin ของภาควิชา แต่ยังคงสามารถแก้ปัญหาที่นักศึกษามีได้อยู่
\end{itemize}
